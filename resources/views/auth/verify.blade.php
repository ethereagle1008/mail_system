            ...
            <div class="row">
                <div class="col col-login mx-auto">
                    <form class="card" method="post">
                        ...
                        <div class="card-title text-center">E-メールを確認する</div>
                        <div class="form-group">
                            <label class="form-label">コード</label>
                            <input type="text" id="code" name="code" class="form-control" placeholder="コードの入力">
                        </div>
                        <div class="form-footer">
                            <button id="btn_submit" type="button" class="btn btn-primary btn-block" onclick="checkCode()">確認</button>
                        </div>
                        <div class="text-center text-muted mt-4">
                            メールが来ないのですか？<a href="javascript:void(0);" id="resend_code" onclick="resendCode()">コードを再送信</a>
                        </div>
                    </div>
                    </form>
                </div>

...
@section('content')
    <div class="side-app">
        <div class="page-header">
            <h4 class="page-title">課金データ一覧</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">課金データ一覧</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <form action="{{url('/manage/pay-list')}}" method="post" name="search" class="card">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-10">
                                <div class="form-group">
                                    <label class="form-label">検索日時</label>
...
{{--                        </div>--}}
                ...
                <div class="card-header">
                    <h3 class="card-title">課金データ一覧</h3>
                </div>
